...
export enum PriceQueryActionTypes {
  ...
  FilterSelectedDate = 'priceQuery.filterSelectedDate'
}
...
export class FilterSelectedDate implements Action {
  readonly type = PriceQueryActionTypes.FilterSelectedDate;
  constructor(public startSelectedDate: string, public endSelectedDate: string) {}
}

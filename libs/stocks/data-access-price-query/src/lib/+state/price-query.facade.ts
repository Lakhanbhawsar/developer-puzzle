...
import { FetchPriceQuery, FilterSelectedDate } from './price-query.actions';
...
export class PriceQueryFacade {
  ...
  filterSelectedDate(startSelectedDate: string, endSelectedDate: string) {
    this.store.dispatch(new FilterSelectedDate(startSelectedDate, endSelectedDate));
  }
}
